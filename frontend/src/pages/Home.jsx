...
const Home = () => {
  ...
  return (
    <DashboardLayout>
      ...
      <div className="w-full p-8 rounded-[2rem] glass-light flex flex-col lg:flex-row justify-between items-center gap-6 relative overflow-hidden shrink-0">
        ...
        <div className="z-10 w-full lg:w-1/2 flex gap-2">
          <input
            ...
            className="flex-1 px-5 py-4 rounded-2xl bg-white/50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-brand-accent transition-all text-gray-900 placeholder:text-gray-400"
          />
        </div>
      </div>
