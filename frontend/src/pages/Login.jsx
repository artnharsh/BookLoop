...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden bg-gradient-to-br from-[#f3f4f6] to-[#e5e7eb]">
      ...
      <div className="flex-1 flex items-center justify-center p-4 z-10">
        <div className="w-full max-w-md p-8 rounded-[2rem] glass-light">
          <h2 className="text-3xl font-bold mb-2 text-center">Welcome Back</h2>
          <p className="text-center text-gray-500 mb-8">Enter your college email to continue</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" className="w-full py-3 mt-4 font-bold rounded-2xl bg-gray-900 text-white hover:scale-[1.02] transition-transform">
              Log In
            </button>
          </form>
